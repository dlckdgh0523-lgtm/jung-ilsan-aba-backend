...
export class RealtimeService {
  ...
  /** Blog sync created new draft articles — admin dashboards show a review prompt. */
  emitBlogSynced(view: unknown): void {
    this.emit('blog.synced', view);
  }
